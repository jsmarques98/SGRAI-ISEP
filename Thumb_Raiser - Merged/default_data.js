...
export const cameraData = {
    ...
    initialViewport: new THREE.Vector4(0.0, 0.0, 1.0, 1.0), // Viewport position and size: % of window width and window height; MUST BE REDEFINED when creating an instance of ThumbRaiser() so that each view is assigned a different viewport
    viewportSizeMin: 0.125, // Expressed in % of window width and window height
    dragOrResizeThreshold: 0.01, // Expressed in % of window width and window height
    snapThreshold: 0.015, // Expressed in % of window width and window height
    snapPositions: [0.0, 0.25, 0.3333333, 0.5, 0.6666667, 0.75, 1.0], // Expressed in % of window width and window height
