...
import { audioData, cubeTextureData, mazeData, playerData, ambientLightData, directionalLightData, spotLightData, flashLightData, shadowsData, fogData, collisionDetectionData, cameraData } from "./default_data.js";
...
export default class ThumbRaiser {
    constructor(audioParameters, cubeTexturesParameters, mazeParameters, playerParameters, ambientLightParameters, directionalLightParameters, spotLightParameters, flashLightParameters, shadowsParameters, fogParameters, collisionDetectionParameters, fixedViewCameraParameters, firstPersonViewCameraParameters, thirdPersonViewCameraParameters, topViewCameraParameters, miniMapCameraParameters) {
        this.audioParameters = merge(true, audioData, audioParameters);
        this.cubeTexturesParameters = merge(true, cubeTextureData, cubeTexturesParameters);
        this.mazeParameters = merge(true, mazeData, mazeParameters);
        this.playerParameters = merge(true, playerData, playerParameters);
        this.ambientLightParameters = merge(true, ambientLightData, ambientLightParameters);
        this.directionalLightParameters = merge(true, directionalLightData, directionalLightParameters);
        this.spotLightParameters = merge(true, spotLightData, spotLightParameters);
        this.flashLightParameters = merge(true, flashLightData, flashLightParameters);
        this.shadowsParameters = merge(true, shadowsData, shadowsParameters);
        this.fogParameters = merge(true, fogData, fogParameters);
        this.collisionDetectionParameters = merge(true, collisionDetectionData, collisionDetectionParameters);
        ...
        // Set the active view camera (fixed view); it always corresponds to the first element in the previous list
